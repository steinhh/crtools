"""
Unit tests for fgaussian_f32 module
"""
...
class TestGaussianBasic:
    ...
    def test_scalar_inputs(self):
        ...
        result = fgaussian_f32(0.0, i0=1.0, mu=0.0, sigma=1.0)
    ...
    def test_peak_location(self):
        ...
        result = fgaussian_f32(x, i0=2.5, mu=3.0, sigma=1.5)
    ...
    def test_fwhm(self):
        ...
        sigma = 2.0
        result = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=sigma)
...
class TestGaussianParameters:
    ...
    def test_different_amplitudes(self):
        ...
        assert fgaussian_f32(x, i0=1.0, mu=0.0, sigma=1.0)[0] == pytest.approx(1.0)
        assert fgaussian_f32(x, i0=2.0, mu=0.0, sigma=1.0)[0] == pytest.approx(2.0)
        assert fgaussian_f32(x, i0=0.5, mu=0.0, sigma=1.0)[0] == pytest.approx(0.5)
    
    def test_different_centers(self):
        """Test mu parameter"""
        for mu in [-5.0, 0.0, 5.0, 10.0]:
            result = fgaussian_f32(mu, i0=1.0, mu=mu, sigma=1.0)
            assert result == pytest.approx(1.0)
    ...
    def test_different_widths(self):
        ...
        result1 = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=1.0)
        result2 = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=2.0)
...
class TestGaussianValidation:
    ...
    def test_zero_sigma_raises(self):
        ...
        with pytest.raises(ValueError, match="sigma must be positive"):
            fgaussian_f32(0.0, i0=1.0, mu=0.0, sigma=0.0)
    
    def test_negative_sigma_raises(self):
        """Negative sigma should raise ValueError"""
        with pytest.raises(ValueError, match="sigma must be positive"):
            fgaussian_f32(0.0, i0=1.0, mu=0.0, sigma=-1.0)
    ...
    def test_array_sigma_raises(self):
        ...
        with pytest.raises(ValueError, match="must be scalars"):
            fgaussian_f32(x, i0=1.0, mu=0.0, sigma=sigma)
...
class TestGaussianNumerical:
    ...
    def test_matches_numpy(self):
        ...
        result = fgaussian_f32(x, i0=i0, mu=mu, sigma=sigma)
    ...
    def test_large_sigma(self):
        ...
        result = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=1000.0)
    ...
    def test_small_sigma(self):
        ...
        result = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=0.01)
...
class TestGaussianTypes:
    ...
    def test_int_input(self):
        ...
        result = fgaussian_f32(0, i0=1.0, mu=0.0, sigma=1.0)
        assert isinstance(result, float)
        assert result == pytest.approx(1.0)
...
class TestGaussianEdgeCases:
    ...
    def test_single_element(self):
        ...
        x = np.array([5.0])
        result = fgaussian_f32(x, i0=2.0, mu=5.0, sigma=1.5)
    ...
    def test_large_array(self):
        ...
        result = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=10.0)
