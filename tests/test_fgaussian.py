...
import numpy as np
import pytest
from ftools import fgaussian_f32, fgaussian_f64
...
class TestGaussianBasic:
    ...
    def test_basic_computation(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=1.0)
        ...
        result_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=1.0)
    ...
    def test_peak_location(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=2.5, mu=mu, sigma=1.5)
        ...
        result_f64 = fgaussian_f64(x_f64, i0=2.5, mu=mu, sigma=1.5)
    ...
    def test_fwhm(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=sigma)
        ...
        result_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=sigma)
...
class TestGaussianParameters:
    ...
    def test_different_amplitudes(self):
        ...
        assert fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=1.0)[0] == pytest.approx(1.0)
        assert fgaussian_f32(x_f32, i0=2.0, mu=0.0, sigma=1.0)[0] == pytest.approx(2.0)
        assert fgaussian_f32(x_f32, i0=0.5, mu=0.0, sigma=1.0)[0] == pytest.approx(0.5)
        
        # Test f64
        x_f64 = np.array([0.0], dtype=np.float64)
        assert fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=1.0)[0] == pytest.approx(1.0)
        assert fgaussian_f64(x_f64, i0=2.0, mu=0.0, sigma=1.0)[0] == pytest.approx(2.0)
        assert fgaussian_f64(x_f64, i0=0.5, mu=0.0, sigma=1.0)[0] == pytest.approx(0.5)
    
    def test_different_widths(self):
        """Test sigma parameter for both versions"""
        # Test f32
        x_f32 = np.array([1.0], dtype=np.float32)
        result1_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=1.0)
        result2_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=2.0)
        assert result2_f32 > result1_f32
        assert result1_f32[0] == pytest.approx(np.exp(-0.5), rel=1e-6)
        
        # Test f64
        x_f64 = np.array([1.0], dtype=np.float64)
        result1_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=1.0)
        result2_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=2.0)
...
class TestGaussianValidation:
    ...
    def test_zero_sigma_raises(self):
        ...
        with pytest.raises(ValueError, match="sigma must be positive"):
            fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=0.0)
        
        with pytest.raises(ValueError, match="sigma must be positive"):
            fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=0.0)
    ...
    def test_negative_sigma_raises(self):
        ...
        with pytest.raises(ValueError, match="sigma must be positive"):
            fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=-1.0)
        
        with pytest.raises(ValueError, match="sigma must be positive"):
            fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=-1.0)
...
class TestGaussianNumerical:
    ...
    def test_large_sigma(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=1000.0)
        assert np.all(result_f32 > 0.999)  # Nearly flat at 1.0
        
        # Test f64
        x_f64 = np.linspace(-10, 10, 100, dtype=np.float64)
        result_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=1000.0)
    ...
    def test_small_sigma(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=0.01)
        peak_idx_f32 = np.argmax(result_f32)
        ...
        result_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=0.01)
        peak_idx_f64 = np.argmax(result_f64)
...
class TestGaussianTypes:
    ...
    def test_float32_input(self):
        ...
        result = fgaussian_f32(x, i0=1.0, mu=0.0, sigma=1.0)
...
class TestGaussianEdgeCases:
    ...
    def test_single_element(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=2.0, mu=5.0, sigma=1.5)
        assert result_f32.shape == (1,)
        assert result_f32[0] == pytest.approx(2.0, rel=1e-6)
        
        x_f64 = np.array([5.0], dtype=np.float64)
        result_f64 = fgaussian_f64(x_f64, i0=2.0, mu=5.0, sigma=1.5)
    ...
    def test_large_array(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=1.0, mu=0.0, sigma=10.0)
        assert result_f32.shape == (n,)
        assert 0 < result_f32.max() <= 1.0
        
        x_f64 = np.linspace(-100, 100, n, dtype=np.float64)
        result_f64 = fgaussian_f64(x_f64, i0=1.0, mu=0.0, sigma=10.0)
...
class TestF32VsF64Comparison:
    ...
    def test_agreement(self):
        ...
        result_f32 = fgaussian_f32(x_f32, i0=2.5, mu=1.5, sigma=3.0)
        result_f64 = fgaussian_f64(x_f64, i0=2.5, mu=1.5, sigma=3.0)
