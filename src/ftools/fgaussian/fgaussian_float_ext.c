 ...
 */
static PyObject *fgaussian_float_gaussian(PyObject *self, PyObject *args)
{
...
/* Method definition */
static PyMethodDef FGaussianFloatMethods[] = {
    {"gaussian", fgaussian_float_gaussian, METH_VARARGS,
     "Float32 Accelerate-optimized Gaussian profile computation\n\n"
     "Uses float32 instead of float64 for 2x memory bandwidth improvement."},
    {NULL, NULL, 0, NULL}};

/* Module definition */
static struct PyModuleDef fgaussian_float_module = {
    PyModuleDef_HEAD_INIT,
    "fgaussian_float_ext",
    "Float32 Accelerate-optimized C extension for computing Gaussian profiles",
    -1,
    FGaussianFloatMethods};

/* Module initialization */
PyMODINIT_FUNC PyInit_fgaussian_float_ext(void)
{
  import_array();
  ...
  return PyModule_Create(&fgaussian_float_module);
}
